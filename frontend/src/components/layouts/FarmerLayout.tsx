    ...
    <div className="dashboard-layout">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link to="/farmer/my-crops" className={`nav-item ${isActive('/farmer/my-crops') ? 'active' : ''}`}>🌾 My Crops</Link>
          <Link to="/farmer/my-requests" className={`nav-item ${isActive('/farmer/my-requests') ? 'active' : ''}`}>📬 Requests</Link>
